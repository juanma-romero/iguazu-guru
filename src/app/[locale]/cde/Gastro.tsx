...
export default function Gastro() {
  const restaurants = Object.values(dataPreview.cde.gastronomia) as Restaurant[]
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-4 lg:p-6">
      ...
      <div className="text-center mb-8">
        <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">
          Gastronomía en Ciudad del Este
        </h1>
        <p className="text-lg text-gray-300 max-w-2xl mx-auto">
          Una fusión de sabores internacionales en el corazón de Paraguay
        </p>
      </div>
