...
/*
El archivo map-handler.tsx define un componente React llamado MapHandler. Este componente se encarga de ajustar la vista del mapa según la ubicación seleccionada. Aquí hay un desglose de lo que hace cada parte del código:
...
Define la estructura de las propiedades que el componente espera recibir. En este caso, una propiedad place que puede ser un objeto google.maps.places.PlaceResult o null.
...
Si place.geometry?.viewport está definido, ajusta la vista del mapa para que se ajuste a los límites de la geometría del lugar seleccionado usando map.fitBounds.
Retorno:
