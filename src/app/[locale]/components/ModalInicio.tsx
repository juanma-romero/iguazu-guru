                ...
                <div className="p-3 sm:p-5">
                    <div className="flex justify-between items-center mb-3">
                        ...
                        <button 
                            ...
                            aria-label="Cerrar"
                        >
                            <svg className='stroke-2' xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor"  strokeLinecap="round" strokeLinejoin="round">
